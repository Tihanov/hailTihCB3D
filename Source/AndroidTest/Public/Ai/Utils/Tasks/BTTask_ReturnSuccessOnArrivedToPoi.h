...
#include "BTTask_ReturnSuccessOnArrivedToPoi.generated.h"

class AAiPointOfInterest;

UCLASS()
class ANDROIDTEST_API UBTTask_ReturnSuccessOnArrivedToPoi : public UBTTaskNode
{
	GENERATED_BODY()

public:
	UBTTask_ReturnSuccessOnArrivedToPoi();
